...
$sql = "SELECT * FROM gadget WHERE id_gadget =  ?";
...
<div class="container">
    <div class="card">
        <div class="card-header text-white bg-primary">
            <h4 class="card-title">
                Edit gadget - <?= $hasil['merk']; ?>
                <div class="float-right">
                    <a class="btn btn-warning" href="gadget.php" role="button">Kembali</a>
                </div>
            </h4>
        </div>
        <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group row">
                                <label class="col-sm-3">Merk gadget</label>
                                <input type="text" class="form-control col-sm-9" value="<?= $hasil['merk']; ?>" id='merk' name="merk" placeholder="Isi Merk">
                            </div>

                            <div class="form-group row">
                                <label class="col-sm-3">Harga</label>
                                <input type="text" class="form-control col-sm-9" value="<?= $hasil['harga']; ?>" id='harga' name="harga" placeholder="Isi Harga">
                            </div>
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group row">
                                ...
                                <input type="text" class="form-control col-sm-9" value="<?= $hasil['deskripsi']; ?>" id='deskripsi' name="deskripsi" placeholder="Isi Deskripsi">
                            </div>
